...
public class ConnectionDB {
    ...
    String ipAddress = "localhost:1433"; // Port mặc định của SQL Server là 1433

    public ConnectionDB() {
        checkDriver();
        DB_Name = "phan_mem_ban_hang_java";
        user_Name = "sa";
        pass = "123";
        setupConnect();
    }
    ...
    private void checkDriver() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "-- ERROR! Không tìm thấy Driver SQL Server");
        }
    }
