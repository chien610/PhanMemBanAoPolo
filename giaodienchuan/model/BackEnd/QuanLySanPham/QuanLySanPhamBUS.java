...
public class QuanLySanPhamBUS {
    ...
    public String[] getHeaders() {
        return new String[]{"Mã sản phẩm", "Mã loại", "Tên", "Đơn giá", "Size", "Số lượng", "Trạng thái"};
    }
        ...
        dssp.forEach((sp) -> {
            if (type.equals("Tất cả")) {
                if (sp.getMaSP().toLowerCase().contains(value.toLowerCase())
                        ...
                        || sp.getSize().toLowerCase().contains(value.toLowerCase())
                ...
                switch (type) {
                    ...
                    case "Đơn giá":
                        ...
                        break;
                          case "Size":
                        if (sp.getSize().toLowerCase().contains(value.toLowerCase())) {
                            result.add(sp);
                        }
                        break;
                    case "Số lượng":
    ...
    public Boolean add(String masp, String malsp, String tensp, float dongia, int soluong,String Size, int trangthai) {
        SanPham sp = new SanPham(masp, malsp, tensp, dongia, soluong,Size, trangthai);
        return add(sp);
    }
    ...
    public Boolean update(String masp, String malsp, String tensp, float dongia, int soluong,String size, int trangthai) {
        Boolean ok = qlspDAO.update(masp, malsp, tensp, dongia, soluong,size, trangthai);
