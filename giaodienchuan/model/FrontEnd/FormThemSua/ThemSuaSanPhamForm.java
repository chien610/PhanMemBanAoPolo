...
public class ThemSuaSanPhamForm extends JFrame {
    ...
    JTextField txSize = new JTextField(15);
    ...
    public ThemSuaSanPhamForm(String _type, String _masp) {
        ...
        txSize.setBorder(BorderFactory.createTitledBorder("Size"));
...
//        plInput.add(plChonAnh);
        ...
        if (this.type.equals("Thêm")) {
            ...
            txTen.setText(this.spSua.getTenSP());
             txSize.setText(this.spSua.getSize());
    ...
    private void btnThemMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlspBUS.add(masp, maloai, ten,dongia, soluong,size, trangthai)) {
    ...
    private void btnSuaMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlspBUS.update(masp, maloai, ten, dongia, soluong,size, trangthai)) {
    ...
    private Boolean checkEmpty() {
        ...
        if (mssp.trim().equals("")) {
            ...
            return showErrorTx(txSize, "Size không được để trống");
