...
public class HienThiSanPham extends FormHienThi {
    ...
    JTextField txSize = new JTextField(12);
    ...
    public HienThiSanPham() {
        ...
        mtb.setHeaders(new String[]{"STT", "Mã sản phẩm", "Mã loại", "Tên", "Đơn giá (triệu)", "Số lượng", "Size", "Trạng thái"});
